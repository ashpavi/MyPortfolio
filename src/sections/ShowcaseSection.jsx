...
const LaptopMockup = ({ imgSrc }) => (
  ...
  <div className="h-full overflow-hidden">
    ...
    {/* Laptop Base */}
    <div className="relative bg-[#1a1a1a] rounded-b-lg h-[9px] md:h-[14px] w-[110%] -left-[5%] shadow-md">
        ...
        {projects.map((project, index) => {
          ...
          return (
            <div
              ...
              ${
                isLast && isOdd
                  ? 'lg:col-span-2 lg:w-[calc(50%-20px)] mx-auto'
                  : ''
              }`}
            >
              {/* LEFT SIDE */}
              ...
              <div className="flex flex-col gap-3 w-full md:w-[50%]">
                ...
                <div className="mt-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white text-black text-[13px] font-bold hover:bg-gray-200 transition-colors duration-300"
                  >
                    View Live Project
